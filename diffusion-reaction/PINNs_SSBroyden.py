...
pinn = Reaction(init_key, units=44)          # input now 4 due to embedding
...
# =====================================================
#  PAPER-STYLE FIELD COMPARISON (Reaction, Equinox PINN)
# =====================================================
